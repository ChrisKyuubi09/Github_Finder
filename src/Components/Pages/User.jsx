                ...
                <div className="col-span-2">
                    <div className="mb-6">
                        <h1 className='text-3xl card-title'>
                            {name}
                            <div className='ml-2 nr-1 badge badge-success'>
                                {type}
                            </div>
                            {hireable && (
                    ...
                    <div className='w-full rounded-lg shadow-md bg-base-100 stats'>
                        ...
                        {twitter_username && (
                            <div className='stat'>
                                ...
                                <div className='text-lg stat-value'>
                                    <a href={`http://twitter.com/${twitter_username}`} target='_blank' rel='noreferrer'>
                                        {twitter_username}
                                    </a>
                                </div>
                            </div>
